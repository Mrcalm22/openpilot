...
from openpilot.selfdrive.ui.widgets.prime import HomeStatusWidget
...
class HomeLayout(Widget):
  def __init__(self):
    ...
    self._status_widget = HomeStatusWidget()
  ...
  def _render_left_column(self):
    self._status_widget.render(self.left_column_rect)
  ...
  def _get_version_text(self) -> str:
    ...
    return format_turbopilot_version(description)
