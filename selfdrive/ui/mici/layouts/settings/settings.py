...
class SettingsLayout(NavScroller):
  def __init__(self):
    ...
    toggles_btn = SettingsBigButton("driving", "", gui_app.texture("icons_mici/settings.png", 64, 64))
    ...
    self._scroller.add_widgets([
      ...
      network_btn,
      device_btn,
      #BigDialogButton("manual", "", "icons_mici/settings/manual_icon.png", "Check out the Turbopilot user\nmanual"),
      developer_btn,
    ])
